...
:::: {.r-stack style="width: 90%; margin: 0 auto;"}
![](images/Multi-agent.png){.fragment .current-visible fragment-index=0}
::::
...
tavily_search_tool = TavilySearch(max_results=1, api_key=tavily_api_key)
...
# Ensure we have the OpenAI API key from environment variables
...
- [Presentation GitHub repo](https://github.com/problemofpoints/ai-agents-cas-spring25)
- Link to app
- [App GitHub repo](https://github.com/problemofpoints/chainladder-python-agent)